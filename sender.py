...
parser.add_argument("--video", type=str, default='./dataset/Video/nature.mp4')
...
parser.add_argument("--max_sender_fps", type=float, default=1/30)
parser.add_argument("--max_video_fps", type=float, default=1/30)
